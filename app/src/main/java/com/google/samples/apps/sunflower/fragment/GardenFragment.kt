...
class GardenFragment : BaseFragment() {
	...
	private val viewModel: GardenPlantingListViewModel by lazyViewModel {
		GardenPlantingListViewModel(sunflowerApplication.plantFeature.gardenPlantingRepository)
	}
